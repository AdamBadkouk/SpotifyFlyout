...
internal static class Notifications
{
    ...
    public static void ShowFirstOrUpdateNotification(string lastKnownVersion, string currentVersion)
    {
        if (String.IsNullOrEmpty(lastKnownVersion))
        {
            ...
            //    .AddText("Welcome to SpotifyFlyout!")
            //    .AddText("Thank you for installing SpotifyFlyout. You can access the settings at any time by clicking the tray icon.")
            //    .Show();
        ...
        if (currentVersion == "debug")
        {
            ...
            //new ToastContentBuilder()
            //    .AddText("SpotifyFlyout Debug Build")
